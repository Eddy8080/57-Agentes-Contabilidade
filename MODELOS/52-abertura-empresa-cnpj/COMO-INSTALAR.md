# abertura-empresa-cnpj — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `52-abertura-empresa-cnpj.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 52-abertura-empresa-cnpj.zip
```
...
cp 52-abertura-empresa-cnpj.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `abertura-empresa-cnpj` na lista.
