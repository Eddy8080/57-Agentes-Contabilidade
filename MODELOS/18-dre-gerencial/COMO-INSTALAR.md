# dre-gerencial — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `18-dre-gerencial.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 18-dre-gerencial.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `dre-gerencial` na lista.
...
```
> use o agente dre-gerencial para [tarefa]
```
