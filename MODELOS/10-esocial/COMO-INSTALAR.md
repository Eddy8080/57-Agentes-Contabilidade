# esocial — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `10-esocial.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 10-esocial.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `esocial` na lista.
...
```
> use o agente esocial para [tarefa]
```
