# folha-pagamento-mensal — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `35-folha-pagamento-mensal.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 35-folha-pagamento-mensal.zip
```
...
cp 35-folha-pagamento-mensal.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `folha-pagamento-mensal` na lista.
...
```
> use o agente folha-pagamento-mensal para [tarefa]
```
