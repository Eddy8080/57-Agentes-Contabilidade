# balancete-analise — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `42-balancete-analise.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 42-balancete-analise.zip
```
...
cp 42-balancete-analise.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `balancete-analise` na lista.
...
```
> use o agente balancete-analise para [tarefa]
```
