# alteracao-contratual — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `53-alteracao-contratual.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 53-alteracao-contratual.zip
```
...
cp 53-alteracao-contratual.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `alteracao-contratual` na lista.
...
```
> use o agente alteracao-contratual para [tarefa]
```
