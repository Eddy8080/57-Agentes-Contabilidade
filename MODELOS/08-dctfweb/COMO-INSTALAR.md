# dctfweb — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `08-dctfweb.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 08-dctfweb.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `dctfweb` na lista.
...
```
> use o agente dctfweb para [tarefa]
```
