# inss-fgts — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `14-inss-fgts.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 14-inss-fgts.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `inss-fgts` na lista.
...
```
> use o agente inss-fgts para [tarefa]
```
