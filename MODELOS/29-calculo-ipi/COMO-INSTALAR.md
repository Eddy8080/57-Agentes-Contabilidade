# calculo-ipi — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `29-calculo-ipi.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 29-calculo-ipi.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `calculo-ipi` na lista.
...
```
> use o agente calculo-ipi para [tarefa]
```
