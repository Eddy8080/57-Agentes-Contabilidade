# admissao — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `15-admissao.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 15-admissao.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `admissao` na lista.
...
```
> use o agente admissao para [tarefa]
```
