# conferencia-guia — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `05-conferencia-guia.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 05-conferencia-guia.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `conferencia-guia` na lista.
...
```
> use o agente conferencia-guia para [tarefa]
```
