# sped-fiscal — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `06-sped-fiscal.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 06-sped-fiscal.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `sped-fiscal` na lista.
...
```
> use o agente sped-fiscal para [tarefa]
```
