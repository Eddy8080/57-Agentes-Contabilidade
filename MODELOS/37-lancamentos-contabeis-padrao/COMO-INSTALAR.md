# lancamentos-contabeis-padrao — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `37-lancamentos-contabeis-padrao.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 37-lancamentos-contabeis-padrao.zip
```
...
cp 37-lancamentos-contabeis-padrao.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `lancamentos-contabeis-padrao` na lista.
...
```
> use o agente lancamentos-contabeis-padrao para [tarefa]
```
