# holerite — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `11-holerite.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 11-holerite.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `holerite` na lista.
...
```
> use o agente holerite para [tarefa]
```
