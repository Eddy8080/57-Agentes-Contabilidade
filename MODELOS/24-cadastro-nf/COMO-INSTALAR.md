# cadastro-nf — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `24-cadastro-nf.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 24-cadastro-nf.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `cadastro-nf` na lista.
...
```
> use o agente cadastro-nf para [tarefa]
```
