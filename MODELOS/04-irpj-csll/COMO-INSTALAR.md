# irpj-csll — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `04-irpj-csll.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 04-irpj-csll.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `irpj-csll` na lista.
...
```
> use o agente irpj-csll para [tarefa]
```
