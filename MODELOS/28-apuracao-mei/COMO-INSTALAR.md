# apuracao-mei — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `28-apuracao-mei.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 28-apuracao-mei.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `apuracao-mei` na lista.
...
```
> use o agente apuracao-mei para [tarefa]
```
