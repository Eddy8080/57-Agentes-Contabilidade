# reforma-tributaria-cbs-ibs — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `57-reforma-tributaria-cbs-ibs.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 57-reforma-tributaria-cbs-ibs.zip
```
...
cp 57-reforma-tributaria-cbs-ibs.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `reforma-tributaria-cbs-ibs` na lista.
...
```
> use o agente reforma-tributaria-cbs-ibs para [tarefa]
```
