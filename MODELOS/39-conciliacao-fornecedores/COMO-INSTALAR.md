# conciliacao-fornecedores — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `39-conciliacao-fornecedores.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 39-conciliacao-fornecedores.zip
```
...
cp 39-conciliacao-fornecedores.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `conciliacao-fornecedores` na lista.
...
```
> use o agente conciliacao-fornecedores para [tarefa]
```
