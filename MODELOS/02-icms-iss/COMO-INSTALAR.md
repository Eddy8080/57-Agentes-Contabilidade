# icms-iss — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `02-icms-iss.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 02-icms-iss.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `icms-iss` na lista.
...
```
> use o agente icms-iss para [tarefa]
```
