# irpf-declaracao-completa — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `51-irpf-declaracao-completa.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 51-irpf-declaracao-completa.zip
```
...
cp 51-irpf-declaracao-completa.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `irpf-declaracao-completa` na lista.
...
```
> use o agente irpf-declaracao-completa para [tarefa]
```
