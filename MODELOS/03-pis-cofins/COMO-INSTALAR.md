# pis-cofins — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `03-pis-cofins.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 03-pis-cofins.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `pis-cofins` na lista.
...
```
> use o agente pis-cofins para [tarefa]
```
