# malha-fina-pj-diagnostico — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `48-malha-fina-pj-diagnostico.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 48-malha-fina-pj-diagnostico.zip
```
...
cp 48-malha-fina-pj-diagnostico.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `malha-fina-pj-diagnostico` na lista.
...
```
> use o agente malha-fina-pj-diagnostico para [tarefa]
```
