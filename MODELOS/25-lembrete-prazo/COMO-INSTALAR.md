# lembrete-prazo — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `25-lembrete-prazo.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 25-lembrete-prazo.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `lembrete-prazo` na lista.
...
```
> use o agente lembrete-prazo para [tarefa]
```
