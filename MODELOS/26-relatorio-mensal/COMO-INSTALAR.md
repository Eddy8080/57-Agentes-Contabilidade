# relatorio-mensal — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `26-relatorio-mensal.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 26-relatorio-mensal.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `relatorio-mensal` na lista.
...
```
> use o agente relatorio-mensal para [tarefa]
```
