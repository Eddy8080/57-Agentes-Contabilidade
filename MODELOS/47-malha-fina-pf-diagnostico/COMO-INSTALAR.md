# malha-fina-pf-diagnostico — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `47-malha-fina-pf-diagnostico.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 47-malha-fina-pf-diagnostico.zip
```
...
cp 47-malha-fina-pf-diagnostico.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `malha-fina-pf-diagnostico` na lista.
...
```
> use o agente malha-fina-pf-diagnostico para [tarefa]
```
