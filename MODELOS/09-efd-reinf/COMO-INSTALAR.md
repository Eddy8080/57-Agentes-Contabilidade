# efd-reinf — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `09-efd-reinf.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 09-efd-reinf.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `efd-reinf` na lista.
...
```
> use o agente efd-reinf para [tarefa]
```
