# dimob — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `33-dimob.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `dimob` na lista.
...
```
> use o agente dimob para [tarefa]
```
