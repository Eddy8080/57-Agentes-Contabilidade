# triagem-whatsapp — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `20-triagem-whatsapp.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 20-triagem-whatsapp.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `triagem-whatsapp` na lista.
...
```
> use o agente triagem-whatsapp para [tarefa]
```
