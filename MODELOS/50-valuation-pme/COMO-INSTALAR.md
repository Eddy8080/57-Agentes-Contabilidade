# valuation-pme — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `50-valuation-pme.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 50-valuation-pme.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `valuation-pme` na lista.
...
```
> use o agente valuation-pme para [tarefa]
```
