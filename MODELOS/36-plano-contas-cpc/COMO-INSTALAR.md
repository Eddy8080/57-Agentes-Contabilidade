# plano-contas-cpc — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `36-plano-contas-cpc.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 36-plano-contas-cpc.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `plano-contas-cpc` na lista.
...
```
> use o agente plano-contas-cpc para [tarefa]
```
