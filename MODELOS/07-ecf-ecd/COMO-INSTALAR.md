# ecf-ecd — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `07-ecf-ecd.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
cp 07-ecf-ecd.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `ecf-ecd` na lista.
...
```
> use o agente ecf-ecd para [tarefa]
```
