# resposta-fiscalizacao-intimacao — Agente Claude Code

Subagente especialista do pacote **57 Agents Contabilidade** (Bravy / ASV Digital).

## O que esse agente faz

Veja o arquivo `56-resposta-fiscalizacao-intimacao.md` (descricao completa, frameworks dominados, tabelas de referencia e fluxo operacional).
...
```bash
unzip 56-resposta-fiscalizacao-intimacao.zip
```
...
cp 56-resposta-fiscalizacao-intimacao.md .claude/agents/
...
**4. Pronto.** Confirme com `/agents`. Voce deve ver `resposta-fiscalizacao-intimacao` na lista.
...
```
> use o agente resposta-fiscalizacao-intimacao para [tarefa]
```
